...
public class DatePickerCell<S, T> extends TableCell<Reminder, LocalDate> {
    private DatePicker datePicker;
    private ObservableList<Reminder> data;
    private String column;

    public DatePickerCell(ObservableList<Reminder> data, String column) {
        super();
    ...
    public void updateItem(LocalDate item, boolean empty) {
        ...
        if (empty) {
            ...
            if (isEditing()) {
                ...
                setDatePickerDate(ReminderCsvFileService.dateTimeFormatter.format(item));
                setText(ReminderCsvFileService.dateTimeFormatter.format(item));
            ...
            public void handle(Event t) {
                ...
                if (null != getData()) {
                    if ("Date".equalsIgnoreCase(column)) {
                        getData().get(index).setDate(date);
                    }
                }
            }
        });
    ...
    public void setBirthdayData(ObservableList<Reminder> data) {
        this.data = data;
    }
